          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Tên khóa học1111" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
                ...
                <FormControl>
                  <div className="relative flex h-[250px] items-center justify-center rounded-md border border-gray-200 bg-white">
                    {imageWatch ? (
                      <Image
                        fill
                        alt={form.getValues("title") || "Course image"}
                        className="size-full rounded-md object-cover"
                        src={imageWatch || "https://utfs.io/f/c97a7c94-663f-4cf9-b027-7030446b96e7-16.jpg"}
                      />
                    ) : (
                      <UploadButton
