...
export const commonClassName = {
  ...
  action: "size-8 rounded-md border flex items-center justify-center p-2 text-gray-500 hover:border-opacity-50 dark:bg-transparent borderDarkMode dark:hover:border-opacity-20",
